...
from .views import (
    ...
    TopicDetailView,
    NewspaperDetailView,
    RedactorDetailView, TopicCreateView, NewspaperCreateView, RedactorCreateView, TopicUpdateView, TopicDeleteView,
    NewspaperUpdateView, NewspaperDeleteView, RedactorUpdateView, RedactorDeleteView,
)
